...
export const generateHealthReport = async (signals: any[], events: any[]): Promise<string> => {
  ...
  Do not use markdown formatting like headers (##) or bold (**) in your response.
  Use plain text with clear section titles and bullet points using simple dashes (-).`;
...
export const generateEventRecommendations = async (eventData: any, relatedSignals: any[]): Promise<{ recommendations: string[], precautions: string[] }> => {
  ...
  Return ONLY simple strings in your arrays - no objects, no markdown formatting.
  Each recommendation and precaution should be a complete, standalone sentence.`;
...
Return your response as a JSON object with two arrays of simple strings:
{
  "recommendations": ["First recommendation", "Second recommendation", ...],
  "precautions": ["First precaution", "Second precaution", ...]
}

Each item should be a complete sentence with no markdown, no formatting, and no nested objects.`;
...
This alert was generated by the Prevora AI Prevention Network.`;
  ...
  Generate comprehensive, informative blog content with proper formatting.
...
Use proper formatting with clear section titles and bullet points.
